...
dia1_parte5 = Scene.create(title: "Dia 1 - Cena 5", story: "Finalmente chegou a hora do almoço. Você decide...", user: User.first, buddy: buddy)
dia1_parte6 = Scene.create(title: "Dia 1 - Cena 6", story: "Após muita luta, você consegue deixar o computador pronto para realizar os exercícios. Você decide...", user: User.first, buddy: buddy)

# dia 2
dia2_parte7 = Scene.create(title: "Dia 2 - Cena 1", story: "Após um primeiro dia, achando que já teria aprendido sobre código, você chega cedo e...", user: User.first, buddy: buddy)
dia2_parte8 = Scene.create(title: "Dia 2 - Cena 2", story: "O professor está explicando sobre Ruby e você...", user: User.first, buddy: buddy)
dia2_parte9 = Scene.create(title: "Dia 2 - Cena 3", story: "Horário do almoço. Você decide:", user: User.first, buddy: buddy)
dia2_parte10 = Scene.create(title: "Dia 2 - Cena 4", story: "Hora de aplicar seus conhecimentos na prática. Os exercícios estão bem difíceis hoje, você decide...", user: User.first, buddy: buddy)
dia2_parte11 = Scene.create(title: "Dia 2 - Cena 5", story: "O professor quer fazer um exercício com o apoio da classe e você é o sorteado pra escrever o código na frente de todos.", user: User.first, buddy: buddy)

# dia 3
dia3_parte12 = Scene.create(title: "Dia 3 - Cena 1", story: "Você já tem seu colega preferido ao ver que tem lugar ao lado dele, você decide...", user: User.first, buddy: buddy)
dia3_parte13 = Scene.create(title: "Dia 3 - Cena 2", story: "As coisas começam a ficar complicadas com o desafio do dia: montar Cookbook!", user: User.first, buddy: buddy)
...
dia3_parte15 = Scene.create(title: "Dia 3 - Cena 4", story: "O dia está quente e você sente muito calor. Algumas pessoas estão espirrando em um ambiente fechado. Você decide...", user: User.first, buddy: buddy)
...
dia4_parte17 = Scene.create(title: "Dia 4 - Cena 2", story: "Finalmente uma matéria menos complexa: SQL. Ao finalizar os exercícios obrigatórios, você...", user: User.first, buddy: buddy)
dia4_parte18 = Scene.create(title: "Dia 4 - Cena 3", story: "Você não consegue se concentrar nas aulas online. Ao se sentir desmotivado, você...", user: User.first, buddy: buddy)
...
# escolhas parte 1
Choice.create(scene: dia1_parte1, next_scene_id: 2, action: "Prossiga", charisma: 0, money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)
...
# escolhas parte 6
Choice.create(scene: dia1_parte6, next_scene_id: 7, action: "Ir para casa, amanhã vai ser tenso", charisma: -3, money: 0, front_end: 0, back_end: 0, stamina: 3, luck: 0)
Choice.create(scene: dia1_parte6, next_scene_id: 7, action: "Ficar um pouco mais e tentar conhecer tudo o que há no local", charisma: 2, money: 0, front_end: 0, back_end: 0, stamina: -2, luck: 0)

# escolhas parte 7
Choice.create(scene: dia2_parte7, next_scene_id: 8, action: "se depara com o professor e começa um papo", charisma: 2, money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)
Choice.create(scene: dia2_parte7, next_scene_id: 8, action: "senta e espera a aula começar", charisma: -2, money: 0, front_end: 0, back_end: 0, stamina: 1, luck: 0)

# escolhas parte 8
Choice.create(scene: dia2_parte8, next_scene_id: 9, action: "faz uma pergunta", charisma: 1, money: 90, front_end: 0, back_end: 5, stamina: 0, luck: 0)
Choice.create(scene: dia2_parte8, next_scene_id: 9, action: "fica mexendo no Instagram", charisma: -2, money: 0, front_end: 0, back_end: -5, stamina: 0, luck: 0)
Choice.create(scene: dia2_parte8, next_scene_id: 9, action: "Estou confiante! Vou partir para os exercícios", charisma: -3, money: 0, front_end: 0, back_end: 2, stamina: -1, luck: 0)

# escolhas parte 9
Choice.create(scene: dia2_parte9, next_scene_id: 10, action: "Ir ao restaurante e dividir um PF com o colega", charisma: 5, money: -2, front_end: 0, back_end: 0, stamina: 0, luck: 0)
Choice.create(scene: dia2_parte9, next_scene_id: 10, action: "Ir ao restaurante esfomeado do jeito que é, pede um prato a la carte sozinho", charisma: -5, money: -5, front_end: 0, back_end: 0, stamina: -3, luck: 0)

# escolhas parte 10
Choice.create(scene: dia2_parte10, next_scene_id: 11, action: "Jogar no google e reza", charisma: 0, money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)
Choice.create(scene: dia2_parte10, next_scene_id: 11, action: "Ver se o buddy entendeu e pede pra explicar", charisma: 2, money: 0, front_end: 0, back_end: 0, stamina: -3, luck: 0)

# escolhas parte 11
Choice.create(scene: dia2_parte11, next_scene_id: 12, action: "Vai na fé e espera que os outros te ajudem", charisma: 0 , money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)
Choice.create(scene: dia2_parte11, next_scene_id: 12, action: "Está confiante e calmo para resolver o exercício sozinho", charisma: 2, money: 0, front_end: 0, back_end: 0, stamina: -3, luck: 0)

# escolhas parte 12
Choice.create(scene: dia3_parte12, next_scene_id: 13, action: "Dar um 'oi' e já sentar perto do seu buddy do dia", charisma: 3 , money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)
Choice.create(scene: dia3_parte12, next_scene_id: 13, action: "Senta ao lado do seu colega e deixa pra mudar de lugar depois", charisma: -3, money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)

# escolhas parte 13
Choice.create(scene: dia3_parte13, next_scene_id: 14, action: "Você quebra a cabeça e se esforça para resolver o desafio", charisma: 0, money: 0, front_end: 0, back_end: 5, stamina: 0, luck: 0)
Choice.create(scene: dia3_parte13, next_scene_id: 14, action: "Pega a cola no GitHub para depois tirar onda com a galera", charisma: 2, money: 0, front_end: 0, back_end: -5, stamina: 0, luck: 0)

# escolhas parte 14
Choice.create(scene: dia3_parte14, next_scene_id: 15, action: "Dar a vez pra quem precisa de poucos minutos para esquentar a comida", charisma:  5, money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)
Choice.create(scene: dia3_parte14, next_scene_id: 15, action: "Mete o louco e deixa 10 minutos no microondas", charisma: -5, money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)

# escolhas parte 15
Choice.create(scene: dia3_parte15, next_scene_id: 16, action: "Abrir a janela e sofrer com o calor", charisma: 5, money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)
Choice.create(scene: dia3_parte15, next_scene_id: 16, action: "Prioriza manter a atenção num ambiente climatizado e liga o ar condicionado no 16º", charisma: -5, money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)

# escolhas parte 16
Choice.create(scene: dia4_parte16, next_scene_id: 17, action: "Prioriza seu aprendizado. Afinal de contas, não testou, não pegou", charisma: -5, money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)
Choice.create(scene: dia4_parte16, next_scene_id: 18, action: "Faz o teste. Descobre que deu positivo e avisa a galera no grupo", charisma: 5, money: 0, front_end: 0, back_end: 0, stamina: -5, luck: 0)

# escolhas parte 17
Choice.create(scene: dia4_parte17, next_scene_id: 19, action: "Parte para os exercícios opcionais e se desafia ainda mais", charisma: 0, money: 0, front_end: 0, back_end: 5, stamina: 0, luck: 0)
...
Choice.create(scene: dia4_parte19, next_scene_id: 20, action: "Yoga é o caramba! Vou terminar os desafios. Namastê!", charisma: 0, money: 0, front_end: 3, back_end: 3, stamina: -2, luck: 0)

# escolhas parte 20
Choice.create(scene: dia5_parte20, next_scene_id: 21, action: "espera começar a aula e enquanto ninguém percebe, guarda um pedaço para mais tarde", charisma: -2, money: 0, front_end: 0, back_end: 0, stamina: 0, luck: 0)
Choice.create(scene: dia5_parte20, next_scene_id: 21, action: "come um pedaço generoso, arriscando ficar indisposto toda a manhã", charisma: -3, money: 0, front_end: 0, back_end: 0, stamina: -4, luck: 0)
Choice.create(scene: dia5_parte20, next_scene_id: 21, action: "fica de boa e espera o almoço", charisma: 3, money: 0, front_end: 0, back_end: 0, stamina: 2, luck: 0)

# escolhas parte 21
Choice.create(scene: dia5_parte21, next_scene_id: 22, action: "prefere Back-End e usa Bootstrap em tudo", charisma: 0, money: 0, front_end: -3, back_end: 0, stamina: 2, luck: 0)
