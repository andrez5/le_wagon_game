...
# dia 1
dia1_parte1 = Scene.create(title: "Dia 1 - Cena 1", story: "Bem-vindo! Você decidiu entrar em um bootcamp. Parabéns! Hoje é o seu primeiro dia de aula, prepare-se!", user: User.first, buddy: buddy, npc_name: "Roberto")
dia1_parte2 = Scene.create(title: "Dia 1 - Cena 2", story: "Você chegou na sala de aula e não conhece ninguém.", user: User.first, buddy: buddy, npc_name: "Roberto")
dia1_parte3 = Scene.create(title: "Dia 1 - Cena 3", story: "O professor está ensinando a fazer o setup e você não entendeu bulhufas.", user: User.first, buddy: buddy, npc_name: "Roberto")
...
dia2_parte8 = Scene.create(title: "Dia 2 - Cena 2", story: "O professor está explicando sobre Ruby.", user: User.first, buddy: buddy, npc_name: "Davis")
...
dia2_parte10 = Scene.create(title: "Dia 2 - Cena 4", story: "Hora de aplicar seus conhecimentos na prática. Os exercícios estão bem difíceis hoje.", user: User.first, buddy: buddy, npc_name: "Alecio2")
...
# dia 3
dia3_parte12 = Scene.create(title: "Dia 3 - Cena 1", story: "Você já tem seu colega preferido. Ao ver que tem lugar disponível ao lado dele, você decide...", user: User.first, buddy: buddy, npc_name: "Michel")
...
# dia 4
dia4_parte16 = Scene.create(title: "Dia 4 - Cena 1", story: "Você acorda se sentindo indisposto. Com novos casos de Covid na classe...", user: User.first, buddy: buddy)
dia4_parte17 = Scene.create(title: "Dia 4 - Cena 2", story: "Finalmente uma matéria menos complexa: SQL. Ao finalizar os exercícios obrigatórios...", user: User.first, buddy: buddy, npc_name: "Dudu")
dia4_parte18 = Scene.create(title: "Dia 4 - Cena 3", story: "Você não consegue se concentrar nas aulas online. Ao se sentir desmotivado...", user: User.first, buddy: buddy, npc_name: "Dudu")
dia4_parte19 = Scene.create(title: "Dia 4 - Cena 4", story: "Chegou a hora da aula de yoga!", user: User.first, buddy: buddy)

# dia 5
dia5_parte20 = Scene.create(title: "Dia 5 - Cena 1", story: "Bom dia! Seu colega comprou um bolo para dividir com a galera. Você já tomou café da manhã.", user: User.first, buddy: buddy, npc_name: "Rodolfo")
...
dia5_parte23 = Scene.create(title: "Dia 5 - Cena 4", story: "O dia chega ao fim e todos estão ouriçados para saber o que rola nesse Happy Hour.", user: User.first, buddy: buddy)
...
dia6_parte26 = Scene.create(title: "Dia 6 - Cena 3", story: "Seu amigo só quer saber de assistir aos jogos da Copa do Mundo, enquanto você e o resto trabalham incessantemente.", user: User.first, buddy: buddy, npc_name: "Rodrigo")
...
# escolhas parte 10
Choice.create(scene: dia2_parte10, next_scene_id: 11, action: "Joga no google e reza", charisma: 0, money: 0, front_end: 0, back_end: 0, stamina: 0)
Choice.create(scene: dia2_parte10, next_scene_id: 11, action: "Vê se o buddy entendeu e pede pra explicar", charisma: 2, money: 0, front_end: 0, back_end: 0, stamina: -3)
...
# escolhas parte 23
Choice.create(scene: dia5_parte23, next_scene_id: 24, action: "Vai direto pra casa, já que não tem obrigação nenhuma de socializar", charisma: -3, money: 0, front_end: 0, back_end: 0, stamina: 5)
Choice.create(scene: dia5_parte23, next_scene_id: 24, action: "Fica uns minutinhos e segue pra casa, já que precisa estudar no final de semana", charisma: 2, money: 0, front_end: 3, back_end: 0, stamina: 2)
Choice.create(scene: dia5_parte23, next_scene_id: 25, action: "Entorna o 'caneco' como se não houvesse amanhã", charisma: 5, money: -3, front_end: 0, back_end: 0, stamina: -3)
...
# escolhas parte 29
Choice.create(scene: dia7_parte29, next_scene_id: 30, action: "Você faz sozinho como um bom capacho", charisma: 2, money: 0, front_end: 3, back_end: 3, stamina: 0)
